package ma.beit.wfahm.web.rest;

import static ma.beit.wfahm.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import ma.beit.wfahm.WfahmApp;
import ma.beit.wfahm.config.Constants;
import ma.beit.wfahm.domain.User;
import ma.beit.wfahm.repository.AuthorityRepository;
import ma.beit.wfahm.repository.UserRepository;
import ma.beit.wfahm.security.AuthoritiesConstants;
import ma.beit.wfahm.service.UserService;
import ma.beit.wfahm.service.dto.PasswordChangeDTO;
import ma.beit.wfahm.service.dto.UserDTO;
import ma.beit.wfahm.web.rest.vm.KeyAndPasswordVM;
import ma.beit.wfahm.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = WfahmApp.class)
